...
# suspect_25_detail=suspect_25_detail["Month", "day", "amount"]

# Nope, that didn't work

#%%

# suspect_25_detail=suspect_25_detail[-1:] + suspect_25_detail[:-1]

# um.. no, that made all the columns null values only
